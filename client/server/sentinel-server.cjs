// sentinel-server.cjs - CommonJS version to run under projects using "type":"module"
...
// Load environment variables from .env and override any existing process.env entries
// This ensures the .env values (in the project) are used instead of system-wide placeholders.
